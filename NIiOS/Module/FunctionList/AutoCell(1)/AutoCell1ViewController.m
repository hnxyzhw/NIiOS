...
@interface AutoCell1ViewController ()<UITableViewDelegate,UITableViewDataSource>
@property(nonatomic,strong) NSArray<NSString*> *objects;
@end


@implementation AutoCell1ViewController

-(void)viewDidLoad{
    [super viewDidLoad];
    //modelVC
    self.navigationItem.title = @"cell高度自适应(1)";
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView{
    DLog(@"currentModel2=%@",[NSRunLoop currentRunLoop].currentMode);
}

...
- (void)setIndexPath:(NSIndexPath *)indexPath{
    ...
    self.titleLabel.text = [NSString stringWithFormat:@"仙剑奇侠传第%zd集",indexPath.row];
}
...
- (void)_setupSubViews
{
    ...
    [MHWebImageTool setImageWithURL:@"https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=2092471158,1396207594&fm=23&gp=0.jpg" placeholderImage:[UIImage imageNamed:@"home_videoCover"] imageView:videoCover];
    ...
    titleLabel.font = NIUIFontSize(14);
    ...
    [playNumsBtn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    ...
    playNumsBtn.titleLabel.font = NIUIFontSize(12);
        ...
        if ([view isKindOfClass:[UIControl class]])
        {
            for (UIView *subview in view.subviews) {
                ...
                if ([subview isKindOfClass:[UIImageView class]]) {
                    ...
                    [subview setValue:[UIColor orangeColor] forKey:@"tintColor"];
                }
            }
        }
    }

...
#import "UICollectionViewController3.h"
...
@interface UICollectionViewController3 ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation UICollectionViewController3
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.mulArray.count>0) {
        ...
        [cell.imageViewHeader setImageWithURL:url options:YYWebImageOptionProgressive];
        [cell.imageViewHeader setContentMode:UIViewContentModeScaleAspectFit];
        cell.labDes.text = avFile.name;
        cell.labDes.font = [UIFont systemFontOfSize:12];
        cell.labDes.textColor = [UIColor redColor];

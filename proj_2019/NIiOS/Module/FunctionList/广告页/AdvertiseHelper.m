...
{
    //NSString *url = @"https://github.com/wvqusrtg";
    //https://nixinsheng.github.io/
    NSString *url = @"https://nixinsheng.github.io/";
    if (!NIIsEmpty(url)) {
        if([[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:url]]) {
            [[UIApplication sharedApplication] openURL:[NSURL URLWithString:url] options:@{@"username" : @"wvqusrtg"} completionHandler:^(BOOL success) {
                NSLog(@"%d", success);
            }];
        }
    }
